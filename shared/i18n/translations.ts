export const translations = {
  en: {
    ...
    rotationAdaptive: "Adaptive (Best for 6+ accounts)",
    rotationAdaptiveDesc: "Weighted scoring — balances quota headroom, load distribution, and timing patterns.",
    rotationLeastUsed: "Smart (Recommended)",
    rotationRoundRobin: "Round Robin",
    rotationLeastUsedDesc: "Use the account with most remaining quota headroom. Resets-soonest tiebreaker.",
    rotationRoundRobinDesc: "Cycle through accounts in order.",
    rotationSaved: "Saved",
    stealthSettings: "Stealth Mode",
    stealthHint: "Anti-detection measures to mimic real Codex Desktop usage patterns.",
    stealthEnabled: "Enable Stealth Mode",
    stealthEnabledHint: "Master toggle for all anti-detection measures.",
    stealthInterval: "Min Request Interval (ms)",
    stealthIntervalHint: "Minimum gap between same-account requests.",
    stealthMaxConcurrent: "Max Concurrent Per Account",
    stealthMaxConcurrentHint: "Real Codex Desktop is single-threaded (1).",
    stealthInstallId: "Per-Account Installation ID",
    stealthInstallIdHint: "Unique install ID per account to avoid correlation.",
    stealthJitter: "Human-like Jitter",
    stealthJitterHint: "Random 0.5–2s extra delay on requests.",
    stealthHourlyLimits: "Hourly Rate Limits (per account)",
    stealthHourlyLimitsHint: "Progressive throttling when account usage exceeds thresholds.",
    stealthWarn: "Warn",
    stealthThrottle: "Throttle",
    stealthPause: "Pause",
    stealthSaved: "Saved",
  ...
  zh: {
    ...
    rotationAdaptive: "自适应（6+账号推荐）",
    rotationAdaptiveDesc: "加权评分 — 综合平衡配额余量、负载分布和请求时序。",
    rotationLeastUsed: "智能分配（推荐）",
    rotationRoundRobin: "轮询",
    rotationLeastUsedDesc: "优先使用配额余量最多的账号，窗口即将刷新的优先。",
    rotationRoundRobinDesc: "按顺序轮流使用各账号。",
    rotationSaved: "\u5df2\u4fdd\u5b58",
    stealthSettings: "隐身模式",
    stealthHint: "反检测措施，模拟真实 Codex Desktop 使用模式。",
    stealthEnabled: "启用隐身模式",
    stealthEnabledHint: "所有反检测措施的主开关。",
    stealthInterval: "最小请求间隔 (ms)",
    stealthIntervalHint: "同账号两次请求之间的最小间隔。",
    stealthMaxConcurrent: "每账号最大并发",
    stealthMaxConcurrentHint: "真实 Codex Desktop 是单线程的 (1)。",
    stealthInstallId: "独立安装 ID",
    stealthInstallIdHint: "每账号独立 ID，避免关联检测。",
    stealthJitter: "人类行为抖动",
    stealthJitterHint: "随机增加 0.5–2s 延迟。",
    stealthHourlyLimits: "每小时速率限制（每账号）",
    stealthHourlyLimitsHint: "账号使用超过阈值时逐级限流。",
    stealthWarn: "警告",
    stealthThrottle: "限流",
    stealthPause: "暂停",
    stealthSaved: "已保存",
